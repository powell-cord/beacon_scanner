...
public class SwiftBeaconsPlugin: NSObject, FlutterPlugin {
    ...
    var eventHandler: EventsStreamHandler?
    let locationManager = CLLocationManager()
    var runInBackground = false

    var listOfRegions = [Item]()

    init(eventHandler: EventsStreamHandler?) {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let instance = SwiftBeaconsPlugin(eventHandler: eventHandler)
        registrar.addMethodCallDelegate(instance, channel: fChannel)
    }
